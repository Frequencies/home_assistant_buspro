...
class OperateCode(Enum):
    ...
    ReadChannelLoadType = b'\xF0\x12'
    ReadChannelLoadTypeResponse = b'\xF0\x13'
    ModifyChannelLoadType = b'\xF0\x14'
    ModifyChannelLoadTypeResponse = b'\xF0\x15'
    ReadLimitOfEveryChannel = b'\xF0\x16'
    ReadLimitOfEveryChannelResponse = b'\xF0\x17'
    ReadSafeguardTimeOfChannel = b'\xF0\x3F'
    ReadSafeguardTimeOfChannelResponse = b'\xF0\x40'
    ModifySafeguardTimeOfChannel = b'\xF0\x41'
    ModifySafeguardTimeOfChannelResponse = b'\xF0\x42'
    ReadDelayOfTurnOnChannel = b'\xF0\x4D'
    ReadDelayOfTurnOnChannelResponse = b'\xF0\x4E'
    ModifyDelayOfTurnOnChannel = b'\xF0\x4F'
    ModifyDelayOfTurnOnChannelResponse = b'\xF0\x50'
    IsDeviceOnline = b'\xF0\x65'
    IsDeviceOnlineResponse = b'\xF0\x66'
    ReadFirmwareVersion = b'\xEE\xFD'
    ReadFirmwareVersionResponse = b'\xEE\xFE'
