...
🇧🇾 Беларуская | [🇩🇪 Deutsch](../de/DEVICE_EXAMPLES.md) | [🇬🇧 English](../en/DEVICE_EXAMPLES.md) | [🇪🇸 Español](../es/DEVICE_EXAMPLES.md) | [🇫🇷 Français](../fr/DEVICE_EXAMPLES.md) | [🇮🇹 Italiano](../it/DEVICE_EXAMPLES.md) | [🇳🇱 Nederlands](../nl/DEVICE_EXAMPLES.md) | [🇳🇴 Norsk](../no/DEVICE_EXAMPLES.md) | [🇷🇺 Русский](../ru/DEVICE_EXAMPLES.md) | [🇺🇦 Українська](../uk/DEVICE_EXAMPLES.md)
...
**Змест:**
- [Пацвярджэнне каманды (НОВАЕ!)](#пацвярджэнне-каманды-новае)
...
## Пацвярджэнне каманды (НОВАЕ!)

### Што такое Пацвярджэнне каманды?

Пацвярджэнне каманды гарантуе, што змены стану прыстасавання адлюстроўваюцца ў Home Assistant толькі пасля таго, як фізічны прыстасаванне пацвердзіць атриманне і выкананне каманды. Гэта прадухіляе рассінхранізацыю інтэрфейса, калі каманды страчваюцца з-за перашкод у сеткі.

**Без Пацвярджэння:**
- Карыстальнік пстрыкае "Уключыць"
- Інтэрфейс абнаўляецца адразу (~5ms)
- Прыстасаванне атрымлівае каманду примерно праз ~100ms
- Калі прыстасаванне не атримае → Інтэрфейс паказвае непаўраўны стан

**З Пацвярджэннем:**
- Карыстальнік пстрыкае "Уключыць"
- Сістэма чакае пацвярджэння прыстасавання (~100-500ms)
- Прыстасаванне пацвярджае атриманне і выкананне
- Інтэрфейс абнаўляецца толькі пасля пацвярджэння
- Калі прыстасаванне не адказвае → Ясная памылка перавышэння часу

### Чаму вам гэта потрэбна

Уключыце пацвярджэнне для:
- **Крытычных прыстасаванняў** - Рэле аварыйнай зупынкі, галоўныя выключальнікі
- **Ненадзейных сетак** - Высокія перашкоды, многа колізій
- **Залежнасцяў аўтаматызацыі** - Аўтаматызацыя, якая патрабуе гарантаванага стану
- **Прыстасаванняў, крытычных для бяспекі** - Сістэмы HVAC, цеплыя поды
...
light:
  - platform: buspro
    devices:
      "1.10.1":
        name: "Рэле аварыйнай зупынкі"
        enable_confirmation: true
        confirmation_timeout: 5.0
        confirmation_retries: 3
```

#### Для Некалькіх Крытычных Прыстасаванняў
...
light:
  - platform: buspro
    devices:
      # Крытычны - пацвердзіць атриманне
      "1.10.1":
        name: "Асноўнае столішнае святло"
        enable_confirmation: true
      
      # Некрытычны - трымаць хутка (па змаўчанні)
      "1.10.2":
        name: "Асяроддзевае асветленне"
        # enable_confirmation па змаўчанні false
  ...
  - platform: buspro
    devices:
      "2.10.1":
        name: "Спальні шторы"
        enable_confirmation: true
        confirmation_timeout: 10.0  # Больш для механічных прыстасаванняў
...
| Параметр | Тыр | По змаўчанні | Дыяпазон | Мета |
|-----------|------|---------|-------|---------| 
| `enable_confirmation` | boolean | `false` | `true`/`false` | Уключыць/выключыць пацвярджэнне |
| `confirmation_timeout` | float | `5.0` | 0.1-60 секунд | Макс. час чакання адказу прыстасавання |
| `confirmation_retries` | integer | `3` | 0-10 | Спробы паўтарэння пры перавышэнні часу |

### Рекамендацыі па Тыпам Прыстасаванняў

| Тыр Прыстасавання | Час Чакання | Паўтарэнні | Прыметкі |
|------------|---------|---------|-------|
| Рэле/Выключальнік | 5.0s | 3 | Хуткі электронны прыстасаванне |
| Святло/Дыммер | 5.0s | 3 | Хуткі электронны прыстасаванне |
| Вентыльтар | 5.0s | 3 | Хуткі электронны прыстасаванне |
| Жалюзі/Штора | 10.0s | 2 | Механічнае прыстасаванне, павольней |
| Клімат AC | 5.0s | 3 | Электронны прыстасаванне |
| Цепла поды | 5.0s | 3 | Электронны прыстасаванне |

### Уплыў на Карыстальніцкі Інтэрфейс

Калі пацвярджэнне уключыто:
- **Затрымка:** Затрымка 100-500ms (супраць 5-10ms без)
- **Зваротны сувяз:** Чёткае паказанне ўспеху/невдалі
- **Надзейнасць:** Гарантавана сінхранізацыя стану

Калі пацвярджэнне выключыто (па змаўчанні):
- **Затрымка:** ~5-10ms (без змен)
- **Паводзіны:** Fire-and-forget (тыповыя паводзіны)
- **Рызыка:** Магчымыя ціхія адказы каманды
